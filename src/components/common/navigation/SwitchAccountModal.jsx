...
const SwitchAccountModal = ({ open, onClose }) => {
    ...
    const [switchingTarget, setSwitchingTarget] = useState(null) // ← for overlay
    ...
    const handleSwitch = async (acc) => {
        ...
        setSwitchingTarget(acc) // ← show overlay immediately
        ...
        try {
            ...
            setSwitchingTarget(null) // hide overlay if falling back
        }
    ...
    return (
        <>
            {/* Switching overlay — outside modal, full screen */}
            <AnimatePresence>
                                            ...
                                            <div className="shrink-0 flex items-center gap-2">
                                                ...
                                                {!isActive && !isSwitching && (
                                                    <button
                                                        ...
                                                        className="p-1 rounded-md text-slate-300 dark:text-slate-600 hover:text-red-500
                                       dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10
