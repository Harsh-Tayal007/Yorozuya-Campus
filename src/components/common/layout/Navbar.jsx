...
const Navbar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  const { authStatus, currentUser, isLoading, logout, hasRole, hasAnyPermission } = useAuth()
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="
              p-2 rounded-lg cursor-pointer relative
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          {/* Install button removed — auto-prompt handled by usePWAInstall */}
