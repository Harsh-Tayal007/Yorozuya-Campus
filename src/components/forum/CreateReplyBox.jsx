...
// threadAuthor = the userId of whoever created the thread (passed from RepliesSection)
export default function CreateReplyBox({ threadAuthor }) {
  ...
  const handleSubmit = async () => {
    ...
    await createReply.mutateAsync({
      ...
      parentReplyId:    null,
      // ── notification fields ──────────────────────────────
      parentAuthorId:   null,               // root reply has no parent comment
      threadAuthorId:   threadAuthor,       // notify the thread creator
    ...
    if (cs.uploadedImagePublicId) {
      try {
        await functions.createExecution(
          CLOUDINARY_FN,
          JSON.stringify({ publicId: cs.uploadedImagePublicId })
        )
        ...
        {!isExpanded ? (
          ...
          <div className="reply-expand flex flex-col">
              ...
              <div className="flex px-4 pt-3">
                <div className="relative inline-flex">
                  {isUploading ? (
                    ...
                    <>
                      <img src={cs.previewImage} alt="preview"
            ...
            {cs.previewGif && (
              <div className="flex px-4 pt-3">
                <div className="relative inline-flex">
                  <img src={cs.previewGif} alt="gif preview"
                       className="max-h-24 max-w-[160px] rounded-lg border border-border object-cover" />
