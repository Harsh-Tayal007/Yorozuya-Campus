      ...
      <ModalShell wide>
        ...
        <div className="rounded-xl bg-muted/60 border border-border p-4 space-y-2 mb-4">
          <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
            <span className="capitalize font-medium text-foreground">{report.targetType}</span>
            <span>•</span>
      ...
      <div className="flex flex-wrap gap-3 mb-5 items-center">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            placeholder={tab === TAB.REPORTS ? "Search by user or reason..." : "Search by username..."}
            ...
            <div key={report.$id}
              ...
              <div className="flex flex-wrap items-start gap-3 mb-3">
                ...
                {report.status === "pending" && canResolve && (
                  <button
                    ...
                    className="shrink-0 px-3 py-1.5 rounded-lg bg-primary/10 border border-primary/30
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-1 text-xs text-muted-foreground">
                ...
                <span>
                  ...
                  <span className="text-foreground">@{report.reporterUsername}</span>
                </span>
                {report.resolvedBy && (
                  <span>
