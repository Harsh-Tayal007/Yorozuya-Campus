      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
        ...
        <div className="flex items-start justify-between mb-4 gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button type="button" onClick={() => setAiModal(true)}
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-xl transition-colors select-none
                         border border-violet-200 dark:border-violet-800 text-violet-600 dark:text-violet-400
                         bg-violet-50 dark:bg-violet-900/20 hover:bg-violet-100 dark:hover:bg-violet-900/40">
            ...
            <div className="text-center py-16 rounded-2xl border-2 border-dashed border-gray-200 dark:border-zinc-700">
              ...
              <div className="flex items-center justify-center gap-2 flex-wrap">
                ...
                <button onClick={() => setAiModal(true)}
                  className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium border border-violet-200 dark:border-violet-800 text-violet-600 dark:text-violet-400 rounded-xl hover:bg-violet-50 dark:hover:bg-violet-900/20 transition-colors">
                  <Sparkles size={13}/> AI Scan
                </button>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => setAiModal(true)}
                  ...
                  <Sparkles size={11}/> Scan from image
                </button>
              </div>
